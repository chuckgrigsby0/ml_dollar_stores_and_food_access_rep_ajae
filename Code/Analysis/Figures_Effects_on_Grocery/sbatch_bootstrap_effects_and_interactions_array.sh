...
#SBATCH --mem=8gb
#SBATCH --qos=accountname-b
#SBATCH --time=00:60:00
#SBATCH --export=model_geography=Rural,model_dep_var=low_access # Rural/Urban
#SBATCH --output=./output/bootstrap_effects_on_ds_x_covars_x_grocery_%A_%a.out
#SBATCH --error=./output/bootstrap_effects_on_ds_x_covars_x_grocery_%A_%a.error
