...
#SBATCH --output=./bootstrap_output/rural_bootstrap_low_access/bootstrap_rel_year_heterogeneity_%A_%a.out
#SBATCH --error=./bootstrap_output/rural_bootstrap_low_access/bootstrap_rel_year_heterogeneity_%A_%a.error
