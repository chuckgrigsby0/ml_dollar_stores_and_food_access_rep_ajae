# Script to compute empirical estimates of model fit using using various accuracy measures, as well as bootstrap standard errors. 
# Results based on out-of-sample CV predictions and errors. 
# Output used as input for latex table presented for R&R. 
# -------------------------------------------------------------------------------------------- #
library(tidymodels)
# -------------------------------------------------------------------------------------------- #
options(scipen = 999)
