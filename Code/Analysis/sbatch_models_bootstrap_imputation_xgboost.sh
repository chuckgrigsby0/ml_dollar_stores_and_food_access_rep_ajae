...
#SBATCH --output=./bootstrap_output/rural_bootstrap_low_access/rural_bootstrap_estimation_%A_%a.out
#SBATCH --error=./bootstrap_output/rural_bootstrap_low_access/rural_bootstrap_estimation_%A_%a.error
