...
# -------------------------------------------------------------------------------------------- #
# Set up data for regressing tau on covariates + Grocery count-x-dollar store entry events. 
# -------------------------------------------------------------------------------------------- #
...
reg_form <- xpd(tau ~ -1 + urban_area + DS_Policy + ..ctrl + Grocery_Count_10mile_2005_bins_recode:entry_events_bins_recode, 
...
reg_model$ll_null
logLik(reg_model)
sqrt(reg_model$ssr/nrow(reg_data))
