...
#SBATCH --output=./bootstrap_output/urban_bootstrap_low_access/bootstrap_errors_and_preds_%A_%a.out
#SBATCH --error=./bootstrap_output/urban_bootstrap_low_access/bootstrap_errors_and_preds_%A_%a.error
