...
directory_boot_diag_type <- paste0('bootstrap_placebo_att', bootstrap_by_tracts) # diag implies diagnostic.
...
saveRDS(emp_placebo_att, here::here('Analysis', directory_geography, directory_dep_var, directory_boot_diag_type, filename))
