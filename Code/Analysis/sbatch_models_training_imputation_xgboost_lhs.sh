...
#SBATCH --mem=75gb  # Used 60 gb for urban models; Used 30 gb for rural models.
...
#SBATCH --output=./tuning_and_training_output/models_imputation_xgboost_urban_la_lhs_%j.out
#SBATCH --error=./tuning_and_training_output/models_imputation_xgboost_urban_la_lhs_%j.error
...
#Run R script
Rscript models_imputation_xgboost_training_lhs.R
