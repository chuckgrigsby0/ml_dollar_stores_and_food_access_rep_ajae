# Script used to estimate bootstrapped counterfactuals using optimal hyperparameters determined by LHS. 
# -------------------------------------------------------------------------------------------- #
# Load packages
# -------------------------------------------------------------------------------------------- #
library(pacman)
...
# -------------------------------------------------------------------------------------------- #  
# Bootstrap sample at tract level. 
# -------------------------------------------------------------------------------------------- #  
...
scale_pos_weight_data <- class_ratios %>% 
  filter(dep_var == model_dep_var) %>% pull(ratio)
...
# Obtain optimal hyperparameter combination from initial tuning. 
...
gc()
# -------------------------------------------------------------------------------------------- #
# Create a simple function to obtain the covariates for model. 
# -------------------------------------------------------------------------------------------- #
# -------------------------------------------------------------------------------------------- #
...
toc()
# -------------------------------------------------------------------------------------------- #
filename = paste0(str_to_lower(model_geography), '_', model_dep_var, '_', 'bootstrap_lhs', '_', bootstrap_id, '.rds')
...
saveRDS(xgb_model_results, here::here('Analysis', 
