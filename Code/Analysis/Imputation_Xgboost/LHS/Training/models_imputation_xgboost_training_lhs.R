# Script to estimate counterfactuals using full sample based on optimal hyperparamters from LHS tuning. 
# -------------------------------------------------------------------------------------------- #  
library('pacman')
...
# Helper function to subset required columns. 
# -------------------------------------------------------------------------------------------- #
...
filename = paste0('xgboost_10m_', str_to_lower(model_geography), '_', model_dep_var, '_final_lhs', '.rds')
