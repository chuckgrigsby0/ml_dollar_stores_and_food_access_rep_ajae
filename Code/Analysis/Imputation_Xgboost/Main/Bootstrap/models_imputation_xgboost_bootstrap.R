...
# -------------------------------------------------------------------------------------------- #  
# Prepare bootstrapped data used in estimation. 
# -------------------------------------------------------------------------------------------- #  
...
# -------------------------------------------------------------------------------------------- #  
# Retrieve optimal hyperparameters from training. 
# -------------------------------------------------------------------------------------------- #  
dir_dep_var <- str_replace_all(str_to_title(str_replace_all(model_dep_var, '_', ' ')), ' ', '_')
hyperparameters <- readRDS(here::here('Analysis', 'Model_Training', dir_dep_var,
                                      paste(str_to_lower(model_geography), model_dep_var, 'hyperparameters.rds', sep = '_')))


# Find value of scale_pos_weight based on bootstrap sample. 
...
# Specify the number of boosting rounds and early stopping criterion. 
