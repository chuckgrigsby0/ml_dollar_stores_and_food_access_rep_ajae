...
#SBATCH --mem=70gb  # Used 60/75 gb for urban models; Used 30 gb for rural models.
#SBATCH --time=20:00:00
#SBATCH --export=model_geography=Urban,model_dep_var=low_access # Rural/Urban
#SBATCH --output=./output/models_imputation_xgboost_urban_la_lhs_w_trends_%j.out
#SBATCH --error=./output/models_imputation_xgboost_urban_la_lhs_w_trends_%j.error
