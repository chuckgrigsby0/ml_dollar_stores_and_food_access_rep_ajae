# Script used to estimate CV models using hyperparameters derived from LHS technique. 
# The optimal hyperparameter set minimizes the CV error. 
# We use the optimal set during model training. 
# ------------------------------ #
library('pacman')
...
gc()
# -------------------------------------------------------------------------------------------- #
# Create a simple function to obtain the covariates for modeling. 
# -------------------------------------------------------------------------------------------- #
...
ntrees = 2000
#--------------------------------------------------------------------------------------------#
param_set <- readRDS(here::here('Analysis', 'Model_Training', 'Low_Access', 'LHS_Results', 'lhs_hyperparameters_training_w_trends.rds') )
#--------------------------------------------------------------------------------------------#
...
saveRDS(training_params, here::here('Analysis', 
                                    'Model_Training', 
                                    dep_var_dir, 
                                    'LHS_Results', 
                                    model_geography, 
