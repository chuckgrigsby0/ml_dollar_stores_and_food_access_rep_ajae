...
#SBATCH --output=./output/tuning_lhs_w_time_trends/urban/urban_tuning_lhs_%A_%a.out
#SBATCH --error=./output/tuning_lhs_w_time_trends/urban/urban_tuning_lhs_%A_%a.error
