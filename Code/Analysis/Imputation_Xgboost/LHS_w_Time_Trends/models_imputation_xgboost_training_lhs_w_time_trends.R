# Script uses optimal hyperparameters from LHS approach to estimate pre-treatment CV errors and post-treatment counterfactuals
# using full sample. Data includes state, year, and state-linear trends for robustness check based on reviewer request. 
# -------------------------------------------------------------------------------------------- #  
library('pacman')
