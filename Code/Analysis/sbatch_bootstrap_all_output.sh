...
Rscript Figures_Errors_and_Effects_on_Retail/analysis_model_bootstrap_errors_and_effects_on_ds_entry_x_baseline_store_counts_array.R

Rscript Figures_Effects_on_Grocery/analysis_model_bootstrap_effects_on_ds_entry_x_covars_array.R $SLURM_ARRAY_TASK_ID

Rscript Figures_Errors_on_Grocery_and_DS_Policy/analysis_model_bootstrap_errors_on_ds_entry_x_grocery_array.R
