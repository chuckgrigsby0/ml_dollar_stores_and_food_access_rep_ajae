# Script used in conjunction with `analysis_plot_effects_and_ds_policy_vars_sourced.R` to produce figures
# of average treatment effects across dollar store policy presence variables (Figures 5 and C.9. in main text).
# -------------------------------------------------------------------------------------------- #
...
# -------------------------------------------------------------------------------------------- #
# Load bootstrap data/estimates from analysis_model_bootstrap_effects_on_ds_policy_vars_array.R 
# -------------------------------------------------------------------------------------------- #
