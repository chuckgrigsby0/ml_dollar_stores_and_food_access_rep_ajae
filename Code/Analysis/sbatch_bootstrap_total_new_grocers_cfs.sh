...
#SBATCH --output=./bootstrap_output/rural_bootstrap_low_access/total_new_grocers_cf/total_new_grocers_%A_%a.out
#SBATCH --error=./bootstrap_output/rural_bootstrap_low_access/total_new_grocers_cf/total_new_grocers_%A_%a.error
