# Script used to train random forest models to find optimal value of ntree. 
# -------------------------------------------------------------------------------------------- #  
# Load packages. 
# -------------------------------------------------------------------------------------------- #  
library(pacman)
p_load('furrr', 'fixest', 'xgboost', 'ranger', 'mlr3verse', 'mlr3tuningspaces', 'future', 'parallelly', 'tictoc', 'here', 'furrr')
# -------------------------------------------------------------------------------------------- #  
