# Script to create hyperparameter matrix using LHS for xgboost models using linear trends w/ state and year FEs.  
...
saveRDS(design, here::here('Analysis', 'Model_Training', 'Low_Access', 'LHS_Results', 'lhs_hyperparameters_training_w_trends.rds'))