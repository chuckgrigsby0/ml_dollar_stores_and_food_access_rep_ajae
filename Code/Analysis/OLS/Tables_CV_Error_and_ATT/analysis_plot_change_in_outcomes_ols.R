# Script computes bootstrapped SEs for OLS-LPM estimates and combines them with the original sample estimates. 
# Saves a preliminary table for further processing into latex table. 
# -------------------------------------------------------------------------------------------- #
options(scipen = 999)
library(readr)
# -------------------------------------------------------------------------------------------- #
