# Helper script to load and prepare data for estimation/analyses. 
# ----------------------------------- #
# Load packages
# ----------------------------------- #
library('pacman')
p_load('here', 'dplyr', 'ggplot2', 'purrr', 'tidyr', 'stringr', 
       'recipes', 'rsample', 'fixest', 'sf', 'tictoc')
# ----------------------------------- #
# Load data. 
# ----------------------------------- #
source(here::here('Code', 'Analysis', 'OLS', 'load_data_for_imputation_estimation_ols.R'))
# ----------------------------------- #

# ----------------------------------- #
# Combine the dollar store entry data of untreated observations, the food access indicators, and all model covariates. 
# ----------------------------------- #
source(here::here('Code', 'Analysis', 'OLS', 'Functions', 'Function_Combine_Treated_or_Untreated_Data_OLS.R'))
