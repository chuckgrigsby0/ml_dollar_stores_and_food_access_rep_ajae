...
#SBATCH --output=./hpg_output/bootstrap_change_in_outcomes_ols_%A_%a.out
#SBATCH --error=./hpg_output/bootstrap_change_in_outcomes_ols_%A_%a.error
...
#Run R script
Rscript analysis_model_bootstrap_change_in_outcomes_array_ols.R $SLURM_ARRAY_TASK_ID
