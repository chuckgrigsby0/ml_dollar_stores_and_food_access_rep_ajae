...
# -------------------------------------------------------------------------------------------- #
filename <- paste0('xgboost_10m_', str_to_lower(model_geography), '_', model_dep_var, '_final_lhs', '.rds'); filename
...
filename <- paste0(str_to_lower(model_geography), '_', 'average_change_in_outcomes_relative_time_lhs.rds')
