...
dir_bootstrap <- paste0('bootstrap_', bootstrap_ids, bootstrap_by_tracts, '_', tt, '_lhs') # NULL or '_tracts'

filename <- paste(str_to_lower(model_geography), model_dep_var, 'bootstrap_lhs', tt, paste0(bootstrap_id, '.rds'), sep = '_')
...
dir_bootstrap <- paste0('bootstrap_change_in_outcomes', bootstrap_by_tracts, '_', 'lhs', '_', tt) # NULL or '_tracts'
