# Script to create tables with pre-treatment average CV error and post-treatment ATTs across urban and rural areas using LHS and linear time trends. 
# -------------------------------------------------------------------------------------------- #
options(scipen = 999)
library(readr)
# -------------------------------------------------------------------------------------------- #
...
# -------------------------------------------------------------------------------------------- #
tt <- 'w_time_trends'
filename <- paste0('xgboost_10m_', str_to_lower(model_geography), '_', model_dep_var, '_final_lhs_', tt, '.rds'); filename
...
dir_bootstrap <- paste0('bootstrap_change_in_outcomes', bootstrap_by_tracts, '_lhs', '_', tt) # NULL or '_tracts'
...
# -------------------------------------------------------------------------------------------- #
filename <- paste0(str_to_lower(model_geography), '_', 'average_change_in_outcomes_relative_time_lhs_', tt, '.rds')
