...
# Effects on covariate bins and integers. 
# -------------------------------------------------------------------------------------------- #
...
map2(plot_chunks, plot_ids, function(.x, .y){
  ...
  ggsave(here::here('Analysis', 'Figures', dir_dep_var, model_geography, paste0('effects_on_covars_bins', bootstrap_by_tracts), # Saves to directories and subdirectories. 
                    figname), 
...
# -------------------------------------------------------------------------------------------- #
# Effects on normalized covariates. 
# -------------------------------------------------------------------------------------------- #
...
map('socioeconomics', function(.x){
  ...
  ggsave(here::here('Analysis', 'Figures', dir_dep_var, model_geography, paste0('effects_on_covars_norm', bootstrap_by_tracts), 
                    figname), 
...
# Effects on dollar store counts and entries. 
...
map2(ds_outcomes_str, ds_outcomes_type_str,
     function(.x, .y){
       ...
       if (length(bin_str) != 0){
         ...
         fig_w_bins <- paste0(str_replace_all(str_to_lower(.y), ds_outcome_type_str_replace), '_', bin_str, '_')
         
       } else {
         
         fig_w_bins <- paste0(str_replace_all(str_to_lower(.y), ds_outcome_type_str_replace), '_')
       ...
       # Saves to directories and subdirectories. 
       ggsave(here::here('Analysis', 'Figures', dir_dep_var, model_geography, paste0('effects_on_dollar_stores', bootstrap_by_tracts), 
                         figname), 
              width = 9, height = 6, unit = 'in', dpi = 600)
...
# Saves to directories and subdirectories. 
ggsave(here::here('Analysis', 'Figures', dir_dep_var, model_geography, paste0('effects_by_region_and_division', bootstrap_by_tracts), 
                  figname), 
       width = 9, height = 6, unit = 'in', dpi = 600)
# -------------------------------------------------------------------------------------------- #
# Division
...
map2(time_type, ds_type, function(.x, .y){ 
  ...
  # Saves to directories and subdirectories. 
  ggsave(here::here('Analysis', 'Figures', dir_dep_var, model_geography, paste0('dollar_store_growth_by_time', bootstrap_by_tracts), 
                    figname), 
         width = 8, height = 6, unit = 'in', dpi = 600)
