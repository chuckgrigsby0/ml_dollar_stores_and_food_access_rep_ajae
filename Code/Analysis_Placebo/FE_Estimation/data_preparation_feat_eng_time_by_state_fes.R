...
#--------------------------------------------------------------------------------------------#
source(here::here('Code', 'Analysis_Placebo', 'FE_Estimation', 'load_data_for_time_by_state_fixed_effects.R'))
#--------------------------------------------------------------------------------------------#
...
saveRDS(time_by_state_fixed_effects, 
        here::here('Data', 'Data_2_and_10_Miles', 'pla_time_by_state_fixed_effects.rds') )
#--------------------------------------------------------------------------------------------#