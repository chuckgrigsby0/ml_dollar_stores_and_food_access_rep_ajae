# Script implements bootstrap procedure using optimal xgboost models found during training. 
# ----------------------------------- #
# Load packages
# ----------------------------------- #
library(pacman)
...
source(here::here('Code', 'Analysis_Placebo', bootstrap_type))
# -------------------------------------------------------------------------------------------- #  
...
hyperparameters <- readRDS(here::here('Analysis_Placebo', 'Model_Training', dir_dep_var,
...
saveRDS(xgb_model_results, here::here('Analysis_Placebo', 
