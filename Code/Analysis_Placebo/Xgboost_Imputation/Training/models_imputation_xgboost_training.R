# Xgboost training on full sample using placebo data. 
# -------------------------------------------------------------------------------------------- #  
# Load packages. 
# -------------------------------------------------------------------------------------------- #  
library('pacman')
...
saveRDS(xgb_cv, here::here('Analysis_Placebo', 'Model_Training', dep_var_dir, filename))
# -------------------------------------------------------------------------------------------- #
# Use the xgb_cv object to estimate final cross-validated models and a final model using 
# all untreated/yet-to-be-treated data using optimal hyperparameters; 
# Apply optimal model to post-treatment data to predict counterfactuals of treated. 
# -------------------------------------------------------------------------------------------- #
gc()
# -------------------------------------------------------------------------------------------- #
...
saveRDS(xgb_model_results, here::here('Analysis_Placebo', 'Model_Training', dep_var_dir, filename))
# -------------------------------------------------------------------------------------------- #
