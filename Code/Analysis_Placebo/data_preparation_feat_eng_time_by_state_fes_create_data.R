...
# ----------------------------------- #
# Load the output containing the state and year FEs from the regression of food-access status of the untreated
# on the covariates. 
# ----------------------------------- #
fe_estimates <- readRDS(here::here('Data', 'Data_2_and_10_Miles', 'pla_time_by_state_fixed_effects.rds'))
# ----------------------------------- #
