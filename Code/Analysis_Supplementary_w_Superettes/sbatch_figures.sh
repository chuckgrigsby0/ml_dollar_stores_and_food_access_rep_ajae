...
echo "Create figures of effects on dollar store entry-x-grocery store-superette counts pre-entry."
#Run R script
Rscript Figures_Effects_on_Grocery_and_Superettes/analysis_plot_effects_on_grocery_and_superettes_sourced.R

echo "Create figures of treatment effects and CV errors regressed on covariates (binned and standardized)."
#Run R script
Rscript Figures_Errors_and_Effects_on_Covars/analysis_plot_effects_and_errors_on_covars_sourced.R

echo "Create figures of treatment effects on dollar store policy variables."
#Run R script
