# Script to estimate bootstrap average treatment effects by dollar store entry and pre-entry grocery store counts (combining 2005 grocery and superettes). 
# Also interacts entries with binned covariates to estimate average treatment effects in terms of those interacted variables. 
# -------------------------------------------------------------------------------------------- #
# Load data. 
# -------------------------------------------------------------------------------------------- #
...
source(here::here('Code', 'Functions', 'Function_effects_on_ds_entry_x_covars_w_superettes.R'))
# -------------------------------------------------------------------------------------------- #
