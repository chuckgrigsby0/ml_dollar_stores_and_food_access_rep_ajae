#!/bin/bash
#SBATCH --job-name=bootstrap_effects_on_ds_entry_x_covars_x_grocery
...
#SBATCH --output=./bootstrap_output/rural_bootstrap_low_access/bootstrap_effects_on_ds_x_covars_x_grocery_%A_%a.out
#SBATCH --error=./bootstrap_output/rural_bootstrap_low_access/bootstrap_effects_on_ds_x_covars_x_grocery_%A_%a.error
