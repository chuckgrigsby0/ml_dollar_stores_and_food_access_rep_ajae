# Helper script to load/prepare data used for plots. 
# -------------------------------------------------------------------------------------------- #
...
# -------------------------------------------------------------------------------------------- #
# Functions to subset the named elements, 
...
# Regression of treatment effects on binned grocery stores/superettes in 2005 with dollar store entries. 
# -------------------------------------------------------------------------------------------- #
