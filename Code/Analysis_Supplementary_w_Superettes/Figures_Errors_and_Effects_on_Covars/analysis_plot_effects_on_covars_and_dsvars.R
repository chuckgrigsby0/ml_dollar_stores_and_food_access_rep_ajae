# Executes scripts that create figures of treatment effects across binned and normalized covariates. 
# Also, creates figures of treatment effects on regional and divisional dummies. 
# See Figures E.5 and E.6
# -------------------------------------------------------------------------------------------- #
# Treatment effects on covariate bins and integers. 
# -------------------------------------------------------------------------------------------- #
...
# -------------------------------------------------------------------------------------------- #
# Treatment effects on normalized covariates. 
# -------------------------------------------------------------------------------------------- #
...
# Treatment effects on dollar store counts and entries. 
