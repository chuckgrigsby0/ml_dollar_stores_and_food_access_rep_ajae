# Main script that calls auxillary scripts that create figures 
# showing average CV errors and treatment effects across binned and normalized covariates. 
# See Figures E.5 and E.6 of supplementary analyses that include superettes in low-access indicator.  
# -------------------------------------------------------------------------------------------- #
# Helper script that loads data (both sample point estimates and bootstrapped standard errors) 
# necessary for creating the figures in the current script. 
# -------------------------------------------------------------------------------------------- #
source(here::here('Code', 
                  'Analysis_Supplementary_w_Superettes', 
...
# -------------------------------------------------------------------------------------------- #
source(here::here('Code', 'Analysis_Supplementary_w_Superettes', 'analysis_plot_effects_on_covars_and_dsvars.R'))

source(here::here('Code', 'Analysis_Supplementary_w_Superettes', 'analysis_plot_errors_on_covars.R'))
# -------------------------------------------------------------------------------------------- #