...
#SBATCH --output=./bootstrap_output/rural_bootstrap_low_access/bootstrap_errors_and_effects_on_covars_%A_%a.out
#SBATCH --error=./bootstrap_output/rural_bootstrap_low_access/bootstrap_errors_and_effects_on_covars_%A_%a.error
