#--------------------------------------------------------------------------------------------#
source(here::here('Code', 'Analysis_Supplementary_w_Supperettes', 'load_data_for_time_by_state_fixed_effects.R'))
#--------------------------------------------------------------------------------------------#
...
estimate_fixed_effects <- function(model_dta){
...
time_by_state_fixed_effects <- estimate_fixed_effects(model_dta = model_data)

time_by_state_fixed_effects <- set_names(time_by_state_fixed_effects, nm = la_names)

saveRDS(time_by_state_fixed_effects, 
        here::here('Data', 'Data_2_and_10_Miles', 'time_by_state_fixed_effects_w_superettes.rds') )
#--------------------------------------------------------------------------------------------#