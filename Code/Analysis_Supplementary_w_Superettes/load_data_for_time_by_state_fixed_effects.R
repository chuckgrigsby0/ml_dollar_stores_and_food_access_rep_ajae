...
dta_untreated <- list(panel_df_ds_entry_2_and_10mile$untreated, 
  ...
  select(-c('DS_Count_10mile':'Grocery_Count_10mile'))
...
# -------------------------------------------------------------------------------------------- #
# Clean up untreated data. Note that NAs exist for a set of block groups for which we do not have census data. 
# -------------------------------------------------------------------------------------------- #
