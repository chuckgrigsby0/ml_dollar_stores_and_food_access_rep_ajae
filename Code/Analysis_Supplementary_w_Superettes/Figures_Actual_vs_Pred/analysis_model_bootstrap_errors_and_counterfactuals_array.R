# Script estimates bootstrapped CV errors and average treatment effects across relative treatment timing;
# counterfactual and actual low-access shares across relative treatment timing. 
# Used for bootstrapped standard errors. 
# ----------------------------------- #
# Load packages
# ----------------------------------- #
options(scipen = 999)
