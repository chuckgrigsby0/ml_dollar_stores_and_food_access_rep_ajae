print('rel_year_on_socio_demog_and_entry_x_grocery <- function(boot_iter)')

rel_year_on_socio_demog_and_entry_x_grocery <- function(boot_iter){
  ...
  reg_table$bootstrap_id <- boot_iter
