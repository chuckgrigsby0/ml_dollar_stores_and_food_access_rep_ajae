# Function to obtain a list of indeces for each training and validation fold observation to be used in XGBoost algorithm. 
...
Train_and_Test_Fold_IDs_Function <- function(dta_w_cv_folds, cv_fold_ids, return_training_ids){
  ...
  # If you would like to obtain the row indeces for the training observations, then specify TRUE. 
  ...
  # If you would like to obtain the row indeces for the validation/test observations, then specify FALSE. 
