...
print('Sourced: Combine_Data_for_DID_Regs_Function')
# -------------------------------------------------------------------------------------------- #
Combine_Data_for_DID_Regs_Function <- function(dta, panel_df_access_inds_x_and_ymile, retail_counts_2005_x_and_ymile, national, geography_str){ # Treated or untreated data. 
